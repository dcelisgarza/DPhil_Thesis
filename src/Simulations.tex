...
We have used PCA on the experimentally derived stress-strain curves (\cref{sf:Ni100,sf:Ni110}) and plotted the first two principal components in \cref{sf:Ni100_pca}, to see whether the low, blue triangles \textcolor{matlabBlue}{$\blacktriangle$}, and high, orange circles \textcolor{matlabOrange}{$\bullet$}, loading rates are significant to the measurements. With so few data points, a clustering analysis on the PCA data would not yield quality information.
\begin{figure}
    \centering
    \begin{subfigure}[t]{0.45\linewidth}
        \centering
