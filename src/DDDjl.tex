...
\begin{enumerate}
  \item prismatic loop with 8 sides, 8 nodes and 8 segments with $\vec{b} = [1\, 1\, 1]$ and $n = \left[\overline{1}\, 1\, 0\right]$,
  \item and a shear loop with 5 sides, 10 nodes and 10 segments with $b = \left[1\, 1\, \overline{1}\right]$ and $n = \left[1\, \overline{1}\, 0\right]$.
\end{enumerate}
