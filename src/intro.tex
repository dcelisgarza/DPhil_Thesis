...
\begin{figure}[t]
	...
	\caption[Diagram of the analytical force calculation on linear rectangular surface elements.]{Diagram of the line integral method used to find analytical expressions for the forces exerted by dislocation on linear rectangular surface elements \cite{analytic_tractions}.
