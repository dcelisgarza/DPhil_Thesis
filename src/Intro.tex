...
The internal stress field of a dislocation loop, $L$, in a homogenous, infinite, linear-elastic medium is given by the contour integral around the loop \cite{mura_t},
