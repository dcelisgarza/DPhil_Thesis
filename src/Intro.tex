...
\Cref{alg:EasyDD} describes the broad processes by which EasyDD goes through in a simulation.
\begin{center}
    ...
    \begin{enumerate}
        ...
        \item Mobilise highly connected, sessile nodes.
        \item Perform separation. This is needed in case there were no collisions, but a separation is now energetically favourable after evolving the network in time, and also for any recently mobilised sessile nodes.
